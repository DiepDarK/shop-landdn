                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="sale_price" name="sale_price"
                                                ...
                                                is-invalid
                                            @enderror"
                                                value="{{ old('sale_price') }}" placeholder="Giá khuyễn mãi">
                                            @error('sale_price')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="short_description" name="short_description"
                                                ...
                                                is-invalid
                                            @enderror"
                                                value="{{ old('short_description') }}" placeholder="Mô tả ngắn sản phẩm" rows="3"></textarea>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <i id="add-row" class="mdi mdi-plus bg-light text-muted fs-18 rounded-2 border ms-3 p-1"
                                                ...
                                                <tbody id="image-table-body">
                                                    <tr>
                                                        <td class="d-flex align-items-center">
                                                            ...
                                                            <input type="file" id="image" name="listImage[id_0]"
