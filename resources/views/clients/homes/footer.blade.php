                                        ...
                                        <div class="kenne-element-carousel brand-slider slider-nav" data-slick-options='{
                                            ...
                                            <div class="brand-item">
                                                <a href="javascript:void(0)">
                                                    <img src="{{asset('assets/client/images/brand/1.png')}}" alt="Brand Images">
                                                </a>
                                            </div>
                                            <div class="brand-item">
                                                <a href="javascript:void(0)">
                                            ...
                                            <div class="brand-item">
                                                <a href="javascript:void(0)">
                                                    <img src="{{asset('assets/client/images/brand/4.png')}}" alt="Brand Images">
                                                </a>
                                            </div>
                                            <div class="brand-item">
                                                <a href="javascript:void(0)">
    ...
    <div class="footer-bottom_area">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="payment">
                        <img src="{{ asset('assets/client/images/footer/payment/1.png')}}" alt="Kenne's Payment Method">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="sp-img_area">
                            ...
                            "asNavFor": ".sp-img_slider-nav"
                                ...
                                <div class="single-slide orange">
                                    <img src="{{ asset('assets/client/images/product/1-2.jpg')}}" alt="Kenne's Product Image">
                                </div>
                                <div class="single-slide brown">
                                    <img src="{{ asset('assets/client/images/product/2-1.jpg')}}" alt="Kenne's Product Image">
                                </div>
                                <div class="single-slide umber">
                                    <img src="{{ asset('assets/client/images/product/2-2.jpg')}}" alt="Kenne's Product Image">
                                </div>
                                ...
                                <div class="single-slide golden">
                                    <img src="{{ asset('assets/client/images/product/3-2.jpg')}}" alt="Kenne's Product Image">
                                </div>
                            </div>
                           ...
                           "spaceBetween": 30
                            ...
                            {"breakpoint":575, "settings": {"slidesToShow": 2}}
                                ...
                                <div class="single-slide red">
                                    <img src="{{ asset('assets/client/images/product/1-1.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                                <div class="single-slide orange">
                                    <img src="{{ asset('assets/client/images/product/1-2.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                                <div class="single-slide brown">
                                    <img src="{{ asset('assets/client/images/product/2-1.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                                <div class="single-slide umber">
                                    <img src="{{ asset('assets/client/images/product/2-2.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                                <div class="single-slide black">
                                    <img src="{{ asset('assets/client/images/product/3-1.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                                <div class="single-slide golden">
                                    <img src="{{ asset('assets/client/images/product/3-2.jpg')}}" alt="Kenne's Product Thumnail">
                                </div>
                            </div>
                        </div>
                    </div>
